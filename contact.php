...
<!-- Section Page-title -->
    <header class="jarallax" data-speed="0.5" style="background-image: url(assets/images/IMG_2767.jpg);">
            ...
            <div class="col-sm-4 mb-3">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">41 หมู่ 11 ตำบลหนองน้ำแดง อำเภอปากช่อง จังหวัดนครราชสีมา</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 mb-3">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p  class="card-text">04-493-8883</p>
                        <p  class="card-text">04-436-5552</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 mb-3">
