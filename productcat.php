...
<!-- Section Page-title -->
    ...
    <section class="jumbotron-fluid">
        <div class="container">
            <h1 class="border-short-bottom text-center">ประเภทสินค้า</h1>
            <div class="row">
                <section class="col-12 col-sm-6 col-md-4 p-3">
                    <div class="card h-100">
                        <a href="productlist.php?id=" class="warpper-card-img">
                        ...
                        <div class="p-3">
                            <a href="productlist.php?id=" class="btn btn-danger btn-block">หินอ่อน</a>
                        </div>
                    </div>
                </section>
                <section class="col-12 col-sm-6 col-md-4 p-3">
                ...
                <section class="col-12 col-sm-6 col-md-4 p-3">
                    <div class="card h-100">
                        ...
                        <div class="p-3">
                            <a href="productlist.php?id=" class="btn btn-danger btn-block">หินตกแต่ง</a>
                        </div>
                    </div>
                </section>
                <section class="col-12 col-sm-6 col-md-4 p-3">
                    <div class="card h-100">
                        ...
                        <div class="p-3">
                            <a href="productlist.php?id=" class="btn btn-danger btn-block">หินธรรมชาติ</a>
                        </div>
                    </div>
                </section>
                <section class="col-12 col-sm-6 col-md-4 p-3">
                    <div class="card h-100">
                        ...
                        <div class="p-3">
                            <a href="productlist.php?id=" class="btn btn-danger btn-block">หินเทียม</a>
                        </div>
                    </div>
                </section>
                <section class="col-12 col-sm-6 col-md-4 p-3">
